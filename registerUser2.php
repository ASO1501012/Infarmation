                ...
                <div class="inner">
                    <table>
                        <tr>
                            <td class="td_top">
                                <p class="p">ユーザーID</p>
                                <!-- styleで指定していたtdのwidthより小さい値を指定し、入力フォームをその大きさに合わせている -->
                                <input type="text" name="userId" placeholder="4文字以上8文字未満" pattern='{4,8}' onblur='this.classList.add("focused")' required class="text">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p class="p">ユーザーネーム</p>
                                <input type="text" name="userName" placeholder="ユーザーネーム(アカウント名)" required onblur='this.classList.add("focused")' class="text">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p class="p">パスワード</p>
                                <input type="password" id="pwd" name="passWord" placeholder="小文字,大文字,数字それぞれを含む8文字以上" pattern='(?=.*[a-z])(?=.*[A-Z])(?=.*\d).{8,}' required onkeyup="setPasswordLevel(this.value);" class="text">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p class="p">再入力</p>
                                <input type="password" name="passWord2" placeholder="再入力してください" pattern='(?=.*[a-z])(?=.*[A-Z])(?=.*\d).{8,}' onblur='this.classList.add("focused")' required class="text">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <p class="p">メールアドレス</p>
                                <input type="email" name="mailAddress" placeholder="メールアドレス" required onblur='this.classList.add("focused")' class="text">
                            </td>
                        </tr>
                        <tr>
                            <td colspan=2>
                                <input type="submit" value="登録" style="background-color:#8181E4;color:#FFFFFF;width:230px;margin-top:20px;border:0;">
                            </td>
                        </tr>
